...
var _DriverCore2 = require('./DriverCore');

var _DriverCore3 = _interopRequireDefault(_DriverCore2);
...
var DriverDefault = function (_DriverCore) {
  _inherits(DriverDefault, _DriverCore);
  ...
  * @return {void}
  */
  function DriverDefault(id, name, type, version, client) {
    _classCallCheck(this, DriverDefault);

    var _this = _possibleConstructorReturn(this, (DriverDefault.__proto__ || Object.getPrototypeOf(DriverDefault)).call(this, id, name, type, version, client));
...
}(_DriverCore3.default);

exports.default = DriverDefault;